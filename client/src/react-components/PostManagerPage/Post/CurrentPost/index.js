...
class Post extends React.Component {
    ...
    editPost(dashboard, newIndex) {
        ...
        api.updateIndexForResearcher(
            dashboard.state.researcher_id,
            newIndex
        ).then((res) => {});
        return (
            <PostEditingPage dashboard={dashboard} key={"key-for-editing"} />
        );
    }
            ...
            <TableRow className="post">
                ...
                <TableCell component="th" scope="row">
                    <Button
                        variant="contained"
                        color="primary"
                        onClick={() => this.editPost(dashboard, index)}
                    >
                        edit
                    </Button>
                </TableCell>
                <TableCell component="th" scope="row">
                    <Button
                        variant="contained"
                        color="primary"
                        onClick={() => removePost(dashboard, index)}
                    >
                        remove
                    </Button>
                </TableCell>
