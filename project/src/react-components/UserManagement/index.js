    ...
    render() {
        function UserList (props) {
            ...
            /** Hardcoding user list */
                ...
                data: [{ username: 'user', email: 'user', usertype: "Student" },
                    { username: 'user2', email: 'user2', usertype: "Researcher" }
                ]
            });
        ...
        function UserRequest (props) {
            ...
            /** Hardcoding user requests */
                ...
                data: [{ username: 'user', email: 'user', usertype: "Student", request: "Change Password" }],
            });
